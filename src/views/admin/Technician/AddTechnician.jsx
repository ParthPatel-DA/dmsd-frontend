...
import { addTechnicianSaga } from '../../../store/actions';
import { 
  ADDRESS_REQUIRED, EMAIL_REQUIRED, EMAIL_VALID, 
  FIRSTNAME_REQUIRED, PHONE_REQUIRED 
...
const AddTechnician = props => {
  ...
  const submitBtnHandler = data => {
    ...
    dispatch(addTechnicianSaga({ data: reqData, closeModel, setIsSubmitted }));
  };
  return (
    <>
      <Model
        headerTitle="Add Technician"
        modalId="signUpModal"
        modalClass="modal-lg"
